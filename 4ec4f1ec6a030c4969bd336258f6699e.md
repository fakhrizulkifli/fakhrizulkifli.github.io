...
```json
{"id":1,"jsonrpc":"2.0","method":"login","params":{"login":"4ACoKdxrH8QeqdY16p9djYF1C4CbX7FB34ECdJxw8CmLTS8DurirbQehgGUdQkLz1gP93ZH57iN6444NkCNW9w9i2UZkYqY","pass":"x","agent":"XMRig/2.6.4 (Linux i686) libuv/1.19.3-dev gcc/7.2.0","algo":["cn/1","cn/0","cn/xtl","cn/msr","cn/xao","cn/rto","cn"]}}<br>
```
